#include <SDL/SDL.h>
#include <SDL/SDL_image.h> // Include SDL_image for loading images
#include <stdlib.h>
#include <time.h>
...
#define SPRITE_WIDTH_1 121
#define SPRITE_HEIGHT_1 134
#define NUM_FRAMES_1 4

#define SPRITE_WIDTH_2 121
#define SPRITE_HEIGHT_2 134
...
int main(int argc, char* args[]) {
    ...
    while (!quit) {
        ...
        drawCharacter(characterX, moveRight ? frame1 : frame2, moveRight ? 1 : 2); // Draw character based on direction of movement
